...
public class PathResponseAssembler {
    public static PathResponse assemble(SubwayPath subwayPath, Map<Long, Station> stations, Fare fare) {
        ...
        return new PathResponse(stationResponses, subwayPath.calculateDuration(), distance, fare.get());
    }
}
